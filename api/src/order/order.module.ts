...
@Module({
  ...
  providers: [OrderService, PaymentU2AService, PaymentA2UService, ...articleOrderProviders, ...paymentA2UProviders, ...paymentU2AProviders, ...orderProviders, ...articleOrderProviders
    , ...articleProviders],
})
